...
# Description: this script will compile and install the The GNU Compiler
# Collection (GCC) to $INSTALL_DIR following GNU conventions.
...
# Remote names
REMOTE_SOURCE="ftp://ftp.gnu.org/gnu/gcc/gcc-4.6.2/gcc-4.6.2.tar.bz2"
REMOTE_SIGNATURE="ftp://ftp.gnu.org/gnu/gcc/gcc-4.6.2/gcc-4.6.2.tar.bz2.sig"
...
AUTHENTICATE=""
CHECK_INTEGRITY=""
CHECK_AUTHENTICITY="gpg --decrypt"
INSTALL_DIR="$HOME" 
...
echo "
Checking authenticity of downloaded files...
------------------------------------------------
"

$CHECK_AUTHENTICITY $PACKAGE
